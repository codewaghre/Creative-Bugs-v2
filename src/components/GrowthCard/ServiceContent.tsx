        ...
        <>
            <BannerContainer className="flex flex-col justify-center items-center">
                <BannerHeadingContainer >
                    <BannerHeading heading="2000+" paragraph="Videos" />
                </BannerHeadingContainer>
                ...
                <BannerConentContainer
                    ...
                    <div className="min-h-10">
                        <h4 className="text-xs py-4 card-md:text-sm">Across industries <span className="text-text-head-two font-semibold">consistent</span> client growth</h4>
                    </div>

                    <div className="py-4 flex flex-col justify-center gap-2 flex-1 h-45">
