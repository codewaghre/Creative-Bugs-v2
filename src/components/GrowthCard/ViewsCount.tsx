        ...
        <>
            <BannerContainer className="flex flex-col justify-between items-center">
                <BannerHeadingContainer>
                    <BannerHeading heading="2 Millions+" paragraph="Views" />
                </BannerHeadingContainer>
                ...
                <BannerConentContainer
                    ...
                    <div className="min-h-10 ">
                        <h4 className="text-xs py-4 card-md:text-sm">Across all platforms <span className="text-text-head-two font-semibold">+245%</span> in a year</h4>
                    </div>
